...
class Advertisement {
  ...
  Advertisement.fromJson(Map<String, dynamic> json) {
    ...
    gatewayIds = json['gateway_id'] != null
        ...
        : null;
    cryptoRate = double.tryParse(json['crypto_rate'].toString()) ?? 0.0;
    fiatRate = double.tryParse(json['fiat_rate'].toString()) ?? 0.0;
    ...
    currencyRate = double.tryParse(json['currency_rate'].toString()) ?? 0.0;
    if (json['gateways'] != String) {
      gateways = <Gateways>[];
      json['gateways'].forEach((v) {
        gateways!.add(Gateways.fromJson(v));
      });
    }
    if (json['fiat_currency'] != null) {
      fiatCurrency = tryCatch(() => Crypto.fromJson(json['fiat_currency']));
    }
    if (json['crypto_currency'] != null) {
...
class PaymentWindow {
  ...
  PaymentWindow.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
